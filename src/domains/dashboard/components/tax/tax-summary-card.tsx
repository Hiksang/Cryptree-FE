    ...
    <div className="bg-bg-surface border border-border-default rounded-[8px] p-6">
      ...
      <div className="space-y-0">
        <div className="flex justify-between items-center h-12">
          <span className="text-[14px] text-text-secondary">총 실현 수익</span>
          <span className="text-[16px] font-semibold text-positive tabular-nums">
            +${data.totalGains.toLocaleString()}
          </span>
        </div>
        <div className="flex justify-between items-center h-12">
          <span className="text-[14px] text-text-secondary">총 실현 손실</span>
        ...
        <div className="flex justify-between items-center h-12">
          <span className="text-[14px] text-text-secondary">순 소득</span>
