...
-- Sample user
INSERT INTO users (auth_id, address, tier, referral_code, tax_country, tax_method) VALUES
  ('dev_user_001', '0xA3b7C8d9E0f1a2B3c4D5e6F7a8B9c0D1e2F3d4', 'gold', 'CRPT-GOLD-7X3K', 'kr', 'fifo')
...
INSERT INTO shop_products (name, description, category, points_cost, stock, tag, badge_label) VALUES
  ('Cryptree Pro (1개월)', 'Cryptree 프로 구독 1개월 이용권. 고급 분석 + 무제한 알림', 'service', 500, NULL, 'hot', '인기'),
  ('Cryptree Genesis NFT', '한정판 Genesis 컬렉션 NFT. 홀더 전용 혜택 포함', 'nft', 2000, 50, 'limited', '50개 한정'),
  ...
  ('Cryptree 후드티', '한정판 Cryptree 브랜드 후드티', 'physical', 3000, 30, 'limited', '30개 한정'),
...
INSERT INTO point_ledger (user_id, amount, type, description) VALUES
  ...
  ('dev_user_001', -500, 'purchase', 'Cryptree Pro (1개월) 교환'),
